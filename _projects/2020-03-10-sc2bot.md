...
For a more detailed numerical analysis of the results, see my writeup (NOTE: link here).

<img src="/images/sc2bot/beacon_trained.gif"
style="border: 0; max-width:960px; max-height:450px">
...
Even though the DQN used by the agents is simple and small and the minigames lack complexity, it still takes a nontrivial amount of computation power to train the agents. For reference, on an Nvidia 8GB RTX 2070, it took about 10 hours to run 10000 episodes and train a network on those episodes.
